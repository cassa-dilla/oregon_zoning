...
# Cassidy Dalva and Thao Phan
# Created: April 28, 2025
# Purpose: Analyze the impact of HB 2001 using IPUMS data
# ===================================================

# --- Set Working Directory ---
# (You only need this if not already set by an R Project)
...
# --- Load Data ---
data_path <- "data/usa_00002 (1).dta.gz"   # Correct filename and path
...
# --- Filter to Oregon ---
# Use 'stateicp == 72' for Oregon (because you have STATEICP, not STATEFIP)
...
# --- (Optional) Save Summaries to Output Folder ---
# Create output/ folder first if it doesn't exist
...
# --- (Optional) Plotting Rent Trends ---
# If you want a simple plot
library(ggplot2)
